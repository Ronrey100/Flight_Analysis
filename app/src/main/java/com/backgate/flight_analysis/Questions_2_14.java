...
public class Questions_2_14 extends ActionBarActivity{
    ...
    protected void onStart() {
        super.onStart();
        Log.d(msg, "The onStart() event 14");
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.d(msg, "The onResume() event 14");
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.d(msg, "The onPause() event 14");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d(msg, "The onDestroy() event 14");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(msg, "The onCreate() event 14");
        initializeVariables();
        ...
        String opt_text_1=this.getString(R.string.option_text_1_14);
        button1.setText("\n"+"\n"+opt_text_1+"\n"+"\n");
        textView_Option1.setText(R.string.frustration);
        String opt_text_2=this.getString(R.string.option_text_2_14);
        button2.setText("\n"+"\n"+opt_text_2+"\n"+"\n");
        ...
        for(int i=0; i<15; i++){
            if("-1".equals(questions_mix_2[i])){
                ...
                inc= i;
                //System.out.println("You are at question_2_14 "+questions_mix[i]+", "+i);
                break;
            }
        }

        //System.out.println("You are at question_2_14 "+question_val+", "+inc);
