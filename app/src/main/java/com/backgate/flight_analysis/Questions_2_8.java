...
public class Questions_2_8 extends ActionBarActivity{
    ...
    protected void onResume() {
        super.onResume();
        Log.d(msg, "The onResume() event 8");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d(msg, "The onDestroy() event 8");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(msg, "The onCreate() event 8");
        initializeVariables();
        ...
        String opt_text_1=this.getString(R.string.option_text_1_8);
        button1.setText("\n"+"\n"+opt_text_1+"\n"+"\n");
        textView_Option1.setText(R.string.physical_demand);
        String opt_text_2=this.getString(R.string.option_text_2_8);
        button2.setText("\n"+"\n"+opt_text_2+"\n"+"\n");
        textView_Option2.setText(R.string.frustration);
        ...
        for(int i=0; i<15; i++){
            if("-1".equals(questions_mix_2[i])){
                ...
                inc= i;
                //System.out.println("You are at question_2_8 "+questions_mix[i]+", "+i);
                break;
            }
        }

        //System.out.println("You are at question_2_8 "+question_val+", "+inc);
    ...
    public void addListenerOnButton() {
        ...
        if(question_val.equals("-1")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    //Intent myIntent = new Intent(Questions_2_8.this, Processing.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
        ...
        if(question_val.equals("0")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_0.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("1")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_1.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("2")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_2.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("3")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_3.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("4")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_4.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("5")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_5.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("6")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_6.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("7")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_7.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("9")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_9.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("10")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_10.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("11")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_11.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("12")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_12.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("13")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_13.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
        ...
        if(question_val.equals("14")) {
            button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
            {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    Intent myIntent = new Intent(Questions_2_8.this, Questions_2_14.class);
                    if (button1.isChecked()) {
                        for (int i = 0; i < 33; i++) {
                            if ("phy_frus".equals(answers_all[i])) {
                                values_all[i] = "Physical Demand";
