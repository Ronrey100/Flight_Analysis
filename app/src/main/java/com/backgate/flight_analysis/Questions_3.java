...
public class Questions_3 extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_Quest.setText("How hurried or rushed was the pace of the task?");
    ...
    public void addListenerOnButton() {
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(Questions_3.this, Questions_4.class);
                for(int i=0; i<30; i++){
                    if("temporal_demand".equals(answers_all[i])){
