...
public class Questions_1 extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_Quest.setText("How mentally demanding was the task?");
    ...
    public void addListenerOnButton() {
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(Questions_1.this, Questions_2.class);
                for(int i=0; i<33; i++){
                    if("mental_demand".equals(answers_all[i])){
