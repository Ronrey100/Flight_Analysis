...
public class Questions_2_0 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String opt_text_1=this.getString(R.string.option_text_1_0);
        button1.setText("\n"+"\n"+opt_text_1+"\n"+"\n");
        textView_Option1.setText(R.string.performance);
        String opt_text_2=this.getString(R.string.option_text_2_0);
        button2.setText("\n"+"\n"+opt_text_2+"\n"+"\n");
    ...
    public void addListenerOnButton() {
        ...
        button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Intent myIntent = new Intent(Questions_2_0.this, activity);
