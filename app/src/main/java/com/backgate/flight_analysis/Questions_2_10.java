...
public class Questions_2_10 extends ActionBarActivity {
    ...
    protected void onStart() {
        super.onStart();
        Log.d(msg, "The onStart() event 10");
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.d(msg, "The onResume() event 10");
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.d(msg, "The onPause() event 10");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d(msg, "The onDestroy() event 10");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(msg, "The onCreate() event 10");
        initializeVariables();
        ...
        String opt_text_1=this.getString(R.string.option_text_1_10);
        button1.setText("\n"+"\n"+opt_text_1+"\n"+"\n");
        textView_Option1.setText(R.string.performance);
        String opt_text_2=this.getString(R.string.option_text_2_10);
        button2.setText("\n" + "\n" + opt_text_2 + "\n" + "\n");
    ...
    public void addListenerOnButton() {
        ...
        button_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Intent myIntent = new Intent(Questions_2_10.this, activity);
                if(activityList.size() == 0) {
